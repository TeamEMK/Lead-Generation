...
export default function LeadDetailModal({ lead, onClose }: LeadDetailModalProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-[#161b27] rounded-2xl shadow-2xl border border-slate-200 dark:border-white/[0.08] overflow-hidden">
        ...
        <div className="flex items-start justify-between gap-3 px-5 pt-6 pb-4">
          <div className="flex items-start gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              {lead.keyword && (
                <span className="inline-flex items-center gap-1 mt-1.5 px-2 py-0.5 rounded-full text-xs font-medium bg-violet-100 dark:bg-violet-500/10 text-violet-700 dark:text-violet-400 border border-violet-200 dark:border-violet-500/20">
