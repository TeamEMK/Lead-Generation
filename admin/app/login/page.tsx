  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#080c18] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#0f1629] border border-white/[0.07] rounded-2xl p-6 shadow-xl">
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 pr-11 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white placeholder-slate-600 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500/50 transition-all"
                />
            ...
            <button type="submit" disabled={loading || !token.trim()}
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-brand-500 hover:bg-brand-600 text-white font-semibold text-sm transition-all disabled:opacity-50">
